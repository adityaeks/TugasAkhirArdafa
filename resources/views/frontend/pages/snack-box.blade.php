...
@section('title', 'Our Kitchen - Snack Box')

@section('content')
    <!-- Hero Section -->
    <div class="relative bg-cover bg-center py-12" style="background-image: url('{{ asset('frontend/images/menu-snack.jpg') }}');">
        ...
        <div class="container mx-auto px-6 lg:px-16 text-center relative z-10">
            <h1 class="text-3xl md:text-4xl font-bold mb-4 text-white">Snack Box</h1>
    ...
    <div class="py-16 bg-gray-50">
        <div class="container mx-auto px-6 lg:px-16">
            <div class="flex flex-col md:flex-row items-center gap-12">
                <!-- Deskripsi -->
                <div class="md:w-1/2">
                    <h2 class="text-3xl font-bold text-gray-800 mb-6">Layanan Snack Box Kami</h2>
                    <p class="text-gray-600 mb-4">
                        Kami menyediakan layanan Snack box untuk kebutuhan makan harian Anda. Setiap menu kami dibuat dengan bahan-bahan berkualitas tinggi, dipersiapkan oleh chef profesional, dan dikemas dengan rapi untuk memastikan kualitas dan kebersihan makanan.
                    </p>
                    <p class="text-gray-600 mb-4">
                ...
                <!-- Foto -->
                <div class="md:w-1/2">
                    <img src="{{ asset('frontend/images/menu-snack.jpg') }}"
                         alt="Snack Box"
    ...
    <main id="menuSection" class="container mx-auto px-6 lg:px-16 py-8">
        ...
        <div class="text-center mb-12">
            <h2 class="text-3xl font-bold text-gray-800">Paket Snack Box</h2>
