            ...
            <div class="row">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($cartItems as $item)
                                        <tr class="d-flex">
                                            ...
                                            <td class="wsus__pro_tk">
                                                <h6 id="{{ $item->rowId }}">
                                                    {{ 'Rp ' . number_format(($item->price + $item->options->variants_total) * $item->qty, 0, ',', '.') }}
                                                </h6>
                                            </td>
                ...
                <div class="col-xl-3">
                    <div class="wsus__cart_list_footer_button" id="sticky_sidebar">
                        <h6>total cart</h6>
                        <p>subtotal: <span id="sub_total">Rp {{ number_format(getCartTotal(), 0, ',', '.') }}</span></p>
                        <p>coupon(-): <span id="discount">Rp {{ number_format(getCartDiscount(), 0, ',', '.') }}</span></p>

                        <p class="total">
                            <span>total:</span>
                            <span id="cart_total">Rp {{ number_format(getMainCartTotal(), 0, ',', '.') }}</span>
                        </p>
                    ...
                    success: function(data) {
                        if (data.status === 'success') {
                            ...
                            console.log('Updated Weight:', data
                                .product_weight); // Menampilkan berat produk yang diperbarui
