...
@section('content')
    <!-- Hero Section -->
    <div class="relative bg-cover bg-center py-12" style="background-image: url('{{ asset('frontend/images/tumpeng.jpg') }}');">
    ...
    <div class="py-16 bg-gray-50">
        <div class="container mx-auto px-6 lg:px-16">
            <div class="flex flex-col md:flex-row items-center gap-12">
                ...
                <!-- Foto -->
                <div class="md:w-1/2">
                    <img src="{{ asset('frontend/images/tumpeng.jpg') }}"
                ...
                <div class="menu-item bg-white rounded-xl shadow-md overflow-hidden animate-fadeIn" data-category="{{ $product->category->name }}"
                    ...
                    <a href="{{ route('product-detail', $product->slug) }}" class="block">
                        <div class="relative">
                            ...
                            {{-- <p>Image Path: {{ asset($product->thumb_image) }}</p> --}}
                            @if($product->product_type == 'new_arrival')
                            <span class="absolute top-2 right-2 bg-orange-500 text-white text-xs font-bold px-2 py-1 rounded-full">BARU</span>
                            @endif
                        </div>
                        <div class="p-4">
